...
@Component({
  selector: 'app-utilidad-diaria-consumo-balanceado',
  templateUrl: './utilidad-diaria-consumo-balanceado.component.html',
  styleUrls: ['./utilidad-diaria-consumo-balanceado.component.css']
})
export class UtilidadDiariaConsumoBalanceadoComponent implements OnInit {

  @Input() listaConsumoBalanceado
   //
