...
@Component({
  selector: 'app-utilidad-diaria-resumen-biologico',
  templateUrl: './utilidad-diaria-resumen-biologico.component.html',
  styleUrls: ['./utilidad-diaria-resumen-biologico.component.css']
})
export class UtilidadDiariaResumenBiologicoComponent implements OnInit {

  @Input() listaResumenBiologico;
  //
