...
export class CostosFechasProrrateadoService {
 ...
 */
  listarCostoPorFechaProrrateado(parametro, contexto, empresaSelect) {
    this.api.post("todocompuWS/produccionWebController/getCostoPorFechaProrrateado", parametro, empresaSelect)
      .then(respuesta => {
        if (respuesta && respuesta.extraInfo) {
          contexto.despuesListarCostoPorFechaProrrateado(respuesta.extraInfo);
        } else {
  ...
  exportarReportePorFechaProrrateado(parametro, contexto, empresaSelect) {
    this.archivoService.postExcel("todocompuWS/produccionWebController/exportarReportePorFechaProrrateado", parametro, empresaSelect)
      .then(data => {
