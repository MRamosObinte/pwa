...
export class ConsumosMensualesComponent implements OnInit {
  ...
  public listadoConsumosMensuales: Array<any> = null;
  ...
  constructor(
    ...
    private consumosMensualesService: ConsumosMensualesService,
  ...
  ngOnInit() {
    ...
    this.listaEmpresas = this.route.snapshot.data['consumosMensuales'];
  ...
  limpiarResultado() {
    this.listadoConsumosMensuales = null;
  ...
  listadoConsumos(form: NgForm) {
    if (this.consumoService.verificarPermiso(LS.ACCION_CONSULTAR, this.empresaSeleccionada, true)) {
      ...
      if (form && form.valid && formularioTocado) {
        ...
        this.consumosMensualesService.listarConsumosMensuales(parametro, this, LS.KEY_EMPRESA_SELECT);
      } else {
  ...
  despuesDeListarConsumosMensuales(data) {
    if (data) {
      data.datos.shift();
      this.retornoTo = data;
      this.listadoConsumosMensuales = data.datos;
  ...
  exportar() {
    if (this.utilService.verificarPermiso(LS.ACCION_EXPORTAR, this, true)) {
      ...
      let parametros = {
        ...
        datos: this.listadoConsumosMensuales
      };
      this.consumosMensualesService.exportarConsumosMensuales(parametros, this, this.empresaSeleccionada);
    }
  }
