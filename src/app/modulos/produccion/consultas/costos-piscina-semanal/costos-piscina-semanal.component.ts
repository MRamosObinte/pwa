...
@Component({
  selector: 'app-costos-piscina-semanal',
  templateUrl: './costos-piscina-semanal.component.html',
  styleUrls: ['./costos-piscina-semanal.component.css']
})
export class CostosPiscinaSemanalComponent implements OnInit {
  ...
  public corridaSeleccionada: PrdListaCorridaTO = new PrdListaCorridaTO();
  public retornoTo: any;
  public listadoCostosPiscinaMultiple: Array<any> = null;
  ...
  constructor(
    ...
    private consumosPiscinaPeriodoService: CostosPiscinaSemanalService,
  ...
  ngOnInit() {
    ...
    this.listaEmpresas = this.route.snapshot.data['costosPiscinaSemanal'];
  ...
  limpiarResultado() {
    this.listadoCostosPiscinaMultiple = null;
  ...
  listadoCostos(form: NgForm, agrupadoPor) {
    if (this.consumoService.verificarPermiso(LS.ACCION_CONSULTAR, this.empresaSeleccionada, true)) {
      ...
      if (form && form.valid && formularioTocado) {
        ...
        this.consumosPiscinaPeriodoService.listarCostoMensualPiscinaMultiple(parametro, this, LS.KEY_EMPRESA_SELECT);
      } else {
  ...
  despuesDeListarCostoMensualPiscinaMultiple(data) {
    if (data) {
      if (data.datos[0][0] === " " || data.datos[0][0] === "") {
        data.datos.shift();
      }
      this.retornoTo = data;
      this.listadoCostosPiscinaMultiple = data.datos;
  ...
  exportar() {
    if (this.utilService.verificarPermiso(LS.ACCION_EXPORTAR, this, true)) {
      ...
      let parametros = {
        ...
        datos: this.listadoCostosPiscinaMultiple
      };
      this.consumosPiscinaPeriodoService.exportarCostoPiscinaSemanal(parametros, this, this.empresaSeleccionada);
    }
  }
