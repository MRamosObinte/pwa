...
@Component({
  selector: 'app-anticipo-proveedores-saldo-general',
  templateUrl: './anticipo-proveedores-saldo-general.component.html',
  styleUrls: ['./anticipo-proveedores-saldo-general.component.css']
})
export class AnticipoProveedoresSaldoGeneralComponent implements OnInit {
  ...
  constructor(
    ...
    private anticipoProveedorService: AnticipoProveedoresSaldoGeneralService
  ) { }
  ...
  ngOnInit() {
    ...
    this.listaEmpresas = this.route.snapshot.data["anticipoProveedorSaldoGeneral"];
  ...
  buscarCarCuentasPorCobrarAnticipos() {
    ...
    if (this.utilService.verificarPermiso(LS.ACCION_CONSULTAR, this, true)) {
      ...
      this.anticipoProveedorService.listarCarListaCuentasPorPagarAnticipos(parametro, this, LS.KEY_EMPRESA_SELECT);
    }
  }

  despuesDeListarCarListaCuentasPorPagarAnticipos(data) {
  ...
  imprimirAnticipoProveedor() {
    if (this.utilService.verificarPermiso(LS.ACCION_IMPRIMIR, this, true)) {
      ...
      this.anticipoProveedorService.imprimirAnticipoProveedores(parametros, this, this.empresaSeleccionada);
    }
  }

  exportarAnticipoProveedor() {
    if (this.utilService.verificarPermiso(LS.ACCION_EXPORTAR, this, true)) {
      ...
      this.anticipoProveedorService.exportarAnticipoProveedores(parametros, this, this.empresaSeleccionada);
    }
  }

  //#region [AG-GRID] 
  iniciarAgGrid() {
    this.columnDefs = this.anticipoProveedorService.generarColumnas();
