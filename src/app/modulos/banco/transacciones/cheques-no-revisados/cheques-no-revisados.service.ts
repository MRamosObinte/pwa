...
export class ChequesNoRevisadosService {
  ...
  listarChequesNoRevisadosTO(parametro, contexto, empresaSelect) {
    this.api.post("todocompuWS/bancoWebController/getBanFunChequesNoRevisadosTO", parametro, empresaSelect)
      .then(respuesta => {
        if (respuesta && respuesta.extraInfo) {
          contexto.despuesListarChequesNoRevisadosTO(respuesta.extraInfo);
        } else {
          contexto.despuesListarChequesNoRevisadosTO([]);
  ...
  insertarBanFunChequesNoRevisados(parametro, contexto, empresaSelect) {
    this.api.post("todocompuWS/bancoWebController/insertarBanFunChequesNoRevisados", parametro, empresaSelect)
      .then(respuesta => {
        if (respuesta && respuesta.extraInfo) {
          this.toastr.success(respuesta.operacionMensaje, LS.TOAST_CORRECTO);
          contexto.despuesInsertarBanFunChequesNoRevisados(parametro.banFunChequesNoRevisadosTO);
        } else {
          contexto.despuesInsertarBanFunChequesNoRevisados([]);
