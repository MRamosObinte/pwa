...
@Component({
  selector: 'app-detalle-anticipos-prestamos',
  templateUrl: './detalle-anticipos-prestamos.component.html',
  styleUrls: ['./detalle-anticipos-prestamos.component.css']
})
export class DetalleAnticiposPrestamosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listaEmpresas = this.route.snapshot.data['anticipoPrestamoDetalle'];
  ...
  listarDetalleAnticiposPrestamos(parametro, form: NgForm) {
