...
export class VentasConsolidadoProductosService {
  constructor(
  ...
  listarInvFunVentasConsolidandoProductosTO(parametro, contexto, empresaSelect) {
    this.api.post("todocompuWS/inventarioWebController/getInvFunVentasConsolidandoProductosTO", parametro, empresaSelect)
      .then(respuesta => {
        if (respuesta && respuesta.extraInfo) {
          contexto.despuesDeListarInvFunVentasConsolidandoProductosTO(respuesta.extraInfo);
        } else {
          contexto.despuesDeListarInvFunVentasConsolidandoProductosTO([]);
